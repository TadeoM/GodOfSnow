...
Mesh::Mesh(Vertex* vertices,int numberOfVerticies, unsigned int* indicies,int numberOfIndicies,ID3D11Device* device)
{
	CreateBuffers(vertices, numberOfVerticies, indicies, numberOfIndicies, device);
...
void Mesh::CreateBuffers(Vertex* vertices, int numberOfVerticies, unsigned int* indicies, int numberOfIndicies, ID3D11Device * device)
{
